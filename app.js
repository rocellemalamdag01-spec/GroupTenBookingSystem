/*
   ...
   Modules: DB · Auth · Cursor · Particles · Spots · Modal ·
            ...
            function resetPaymentSection() {
              ...
              /* Clear card fields */
              ['cardNumber','cardName','cardExpiry','cardCvv','ewalletNumber','bankRefNumber'].forEach(id => {
                const el = document.getElementById(id);
                if (el) el.value = '';
              });
              /* Reset card preview */
            ...
            function validatePayment() {
              ...
              if (method === 'bank') {
                const ref = document.getElementById('bankRefNumber').value.trim();
                if (!ref) {
                  showToast('⚠️ Reference Required', 'Enter your transfer reference or sender name.', '#f77f00');
                  return false;
                }
                return method;
              }
